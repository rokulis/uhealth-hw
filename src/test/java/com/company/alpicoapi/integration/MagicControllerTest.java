...
public class MagicControllerTest {
    ...
    public final static String IMAGE = """
            ...
            <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"\s
    ...
    @ValueSource(strings = {
            ...
            "9~§21§", "`@;']",
            "bitte", "onegaishimasu", "medikas", "_a12", "n1a2d3a4l5", "kompiūter8s", "8881", "!@#$%^&*()_+/.,\\][;[];a"
    })
